...
IsaacLabJointOrder = ['L_hip_roll', 'R_hip_roll', 'waist_yaw', 'L_hip_pitch', 'R_hip_pitch', 'waist_roll', 'L_hip_yaw', 'R_hip_yaw', 'L_knee_pitch', 'R_knee_pitch','L_ankle_pitch', 'R_ankle_pitch']
MujocoJointOrder = ['waist_yaw',  'waist_roll', 'L_hip_roll','L_hip_pitch', 'L_hip_yaw',   'L_knee_pitch', 'L_ankle_pitch', 'R_hip_roll', 'R_hip_pitch',  'R_hip_yaw',   'R_knee_pitch',  'R_ankle_pitch']
RealJointOrder = ['waist_roll',  'waist_yaw', 'L_hip_roll','L_hip_pitch', 'L_hip_yaw',   'L_knee_pitch', 'L_ankle_pitch', 'R_hip_roll', 'R_hip_pitch',  'R_hip_yaw',   'R_knee_pitch',  'R_ankle_pitch']
...
# print("Mujoco to Real indices:", Mujoco_to_Real_indices)
...
class Sim2Real(LegBase):
    ...
    def update_rc_command(self):
        self.command[0] = get_command(self.command[0], self.rc.state.LEFT_Y  * 1.5, 0.001)
        self.command[1] = get_command(self.command[1], self.rc.state.LEFT_X  * 0.5, 0.001)
        self.command[2] = get_command(self.command[2], self.rc.state.RIGHT_X * 0.5, 0.001)
        print(self.command)
        # 遥控器键值变步频处理
