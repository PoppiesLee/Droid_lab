...
RealJointOrder =     [ 'waist_roll',  'L_hip_roll', 'L_hip_pitch',   'L_hip_yaw', 'L_knee_pitch', 'L_ankle_pitch', 'L_ankle_roll',  'waist_yaw',   'R_hip_roll',  'R_hip_pitch',     'R_hip_yaw',  'R_knee_pitch', 'R_ankle_pitch', 'R_ankle_roll']
...
class Sim2Real(LegBase):
    ...
    def get_obs(self, gait_process):
        ...
        obs[11: 25] = (q- self.cfg.default_joints)[Real_to_Isaac_indices]
        obs[25: 39] = dq[Real_to_Isaac_indices]
        obs[39: 53] = self.action[Real_to_Isaac_indices]
