...
mujoco_model_path = f"../legged_lab/assets/droid/X03/scene.xml"
MAX_LINE_VEL  = 1.5
MAX_ANGLE_VEL = 0.5
...
# IsaacLabJointOrder = ['waist_yaw', 'waist_roll','L_hip_roll', 'R_hip_roll', 'L_hip_pitch', 'R_hip_pitch', 'L_hip_yaw', 'R_hip_yaw', 'L_knee_pitch', 'R_knee_pitch', 'L_ankle_pitch', 'R_ankle_pitch']
...
class Sim2Mujo():
    ...
    def update_rc_command(self):
        self.rc.get_gamepad()
        self.command[0] = get_command(self.command[0], self.rc.state.LEFT_Y * 2, 0.5)
