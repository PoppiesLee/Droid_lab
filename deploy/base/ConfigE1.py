...
class Config:
    ...
    dof_stiffness = np.array([250.0000,  350.0000,  100.0000,   300.0000,  300.0000,  200.0000,  250.0000,  350.0000,  100.0000,   300.0000,  300.0000,  200.0000,  100.0], dtype=np.float32)
    dof_stiffness*=1.0
    dof_damping = np.array([   10.0000,   20.0000,    5.0000,    30.0000,   30.0000,   15.0000,   10.0000,   20.0000,    5.0000,    30.0000,   30.0000,   15.0000,    5.0], dtype=np.float32)
