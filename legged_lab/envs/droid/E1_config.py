...
class E1RewardCfg(RewardCfg):
    ...
    feet_too_near = RewTerm(func=mdp.feet_too_near_humanoid, weight=-3.0,params={"asset_cfg": SceneEntityCfg("robot", body_names=[".*ankle_pitch.*"]),"threshold": 0.3})
    ...
    joint_deviation_hip_yaw = RewTerm(func=mdp.joint_deviation_l1, weight=-5.0,params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_hip_yaw_joint"])})
    joint_deviation_hip_roll = RewTerm(func=mdp.joint_deviation_l1, weight=-0.2,params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_hip_roll_joint"])})
    ...
    joint_deviation_legs_knee = RewTerm(func=mdp.joint_deviation_l1, weight=-0.02,params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_knee.*"])})
    ...
    joint_deviation_ankle = RewTerm(func=mdp.joint_deviation_l1, weight=-0.05,params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_ankle_roll.*"])})
    ...
    feet_height = RewTerm(func=mdp.feet_height, weight=-5.0,params={"asset_cfg": SceneEntityCfg("robot", body_names=[".*ankle_pitch.*"]),"sensor_cfg": SceneEntityCfg("contact_sensor", body_names=[".*ankle_pitch.*"])})
@configclass
